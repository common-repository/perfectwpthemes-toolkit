...
/**
 * Class for declaring the importer used in the Perfectwpthemes Demo Importer plugin
 */

class PWPT_Importer_Main {
	...
	public function __construct( $importer_options = array(), $logger = null ) {
		...
		$this->importer = new PWPT_WXR_Importer( $importer_options );

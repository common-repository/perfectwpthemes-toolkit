<?php
/**
 * WXR importer class used in the Perfectwpthemes Demo Importer plugin.
 * Needed to extend the PWPT_Importer_WXR_Importer class to get/set the importer protected variables,
 * for use in the multiple AJAX calls.
 */
class PWPT_WXR_Importer extends PWPT_Importer_WXR_Importer {
	...
	/**
	 * Get all protected variables from the PWPT_Importer_WXR_Importer needed for continuing the import.
	 */
	...
	/**
	 * Sets all protected variables from the PWPT_Importer_WXR_Importer needed for continuing the import.
	 *
